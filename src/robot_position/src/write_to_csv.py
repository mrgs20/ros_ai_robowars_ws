...
class Robot_position:
    def __init__(self):
        ...
        self.subs = message_filters.ApproximateTimeSynchronizer([self.us1_sub, self.us2_sub,
                                                                 self.us3_sub, self.us4_sub,
                                                                 self.us5_sub, self.us6_sub,
                                                                 self.odom_sub], queue_size=1,
                                                                 slop=0.9, allow_headerless=True)
    ...
    def sensor_cb(self, us1_sub, us2_sub, us3_sub, us4_sub, us5_sub, us6_sub, odom_sub):
        ...
        if self.write_to_csv_counter > 19:
            self.positions_writer.writerow([yaw_radians, us1_sub.range, us2_sub.range, us3_sub.range,
